...
$sql =  $db->prepare(" SELECT * from houses WHERE house_owner = \"$username\" ");
if( $sql->execute() ){ 
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto mr-auto">
          <div class="card card-register">
            <h3 class="title mx-auto"> ادارة المنزل </h3>
            <form class="register-form"  method="post" enctype="multipart/form-data" >
              <label>اسم المستخدم</label>
              <input type="text" class="form-control" placeholder="Username" name="username" value="اسماعيل">
              <input class="btn btn-danger btn-block btn-round" type="submit" name="submit" value="ادخل" >
              <br>
